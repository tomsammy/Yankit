  ...
  return (
    <StaticPageLayout title="Cookie Policy" icon={Cookie}>
      ...
      <p>
        ...
        of our users to enhance the experience on our Platform. Third parties
        serve cookies through our Platform for advertising, analytics, and other
      ...
      <ul className="list-disc list-inside ml-4 space-y-2">
        <li>
          ...
          essential to provide you with services available through our Platform
          and to enable you to use some of its features, such as access to
          secure areas. Because these cookies are strictly necessary to deliver
          the Platform to you, you cannot refuse them without impacting how our
          Platform functions.
        </li>
        <li>
          <strong>Performance and Functionality Cookies:</strong> These cookies
          are used to enhance the performance and functionality of our Platform
          but are non-essential to their use. However, without these cookies,
          certain functionality (like remembering your login details or
        ...
        <li>
          ...
          Examples include cookies from Google Analytics.
        </li>
        <li>
          <strong>Advertising (Targeting) Cookies:</strong> These cookies are
          used to make advertising messages more relevant to you and your
          interests. They perform functions like preventing the same ad from
        ...
        <li>
          ...
          enable you to share pages and content that you find interesting on our
          Platform through third-party social networking and other websites.
      ...
      <ul className="list-disc list-inside ml-4 space-y-2">
        <li>
          <strong>Browser Controls:</strong> Most web browsers allow some
          control of most cookies through the browser settings. You can set or
          amend your web browser controls to accept or refuse cookies. If you
          choose to reject cookies, you may still use our Platform though your
          access to some functionality and areas of our Platform may be
          restricted. To find out more about cookies, including how to see what
        ...
        <li>
          <strong>Opting out of interest-based advertising:</strong> Many
          ...
          (for EU users). Australian users can visit{" "}
          <a
        ...
        <li>
          <strong>Platform Cookie Consent Tool:</strong> When you first visit
          our Platform, you may be presented with a cookie banner or consent
          tool that allows you to set your preferences.
        </li>
      </ul>
      <p>
      ...
      <p>
        ...
        enable us to recognize when someone has visited our Platform or opened
        an email that we have sent them. This allows us, for example, to monitor
        the traffic patterns of users from one page within our Platform to
        another, to deliver or communicate with cookies, to understand whether
        you have come to our Platform from an online advertisement displayed on
        a third-party website, to improve site performance, and to measure the
