  ...
  return (
    <StaticPageLayout title="Careers at Yankit" icon={Briefcase}>
      ...
      <ul className="list-disc list-inside ml-4 space-y-2">
        <li>
          <strong>Impactful Work:</strong> Be part of a platform that is making
          a real difference by connecting people and optimizing resources.
        </li>
        <li>
          <strong>Innovative Environment:</strong> We foster a culture of
          creativity, collaboration, and continuous learning.
        </li>
        <li>
          <strong>Growth Opportunities:</strong> As we expand, so do the
          opportunities for our team members to grow and develop their careers.
        </li>
        <li>
          <strong>Diverse Team:</strong> We value diversity and believe it
          drives innovation. We are an equal opportunity employer.
        </li>
        <li>
          <strong>Great Culture:</strong> Join a supportive and energetic team
          that is passionate about what we do.
        </li>
      </ul>
      ...
      <p>
        We are always on the lookout for talented individuals. While we may not
        have specific roles listed at all times, we encourage you to reach out
        if you believe your skills and passion align with our mission.
      </p>
      ...
      <p className="font-medium text-primary dark:text-secondary">
        <a href="mailto:careers@yankit.com.au" className="hover:underline">
          careers@yankit.com.au
        </a>
      </p>
      <p>
        Please include the type of role you are interested in (e.g., Software
        Development, Marketing, Customer Support, Operations) in the subject
        line of your email.
      </p>
      <p>
      ...
      <p>
        We look forward to hearing from talented individuals who want to be part
