  ...
  return (
    <StaticPageLayout title="Terms of Service" icon={FileText}>
      ...
      <p>
        ...
        for an account, you represent and warrant that all information you
        provide is accurate, current, and complete. You are responsible for
      ...
      <ul className="list-disc list-inside ml-4 space-y-2">
        <li>
          ...
          laws and regulations, including customs and airline regulations.
        </li>
        <li>
          Provide accurate and truthful information in your listings,
          communications, and profile.
        </li>
        <li>
          Use the Platform for lawful purposes only and not to send or carry
          prohibited items (including, but not limited to, illegal substances,
          weapons, hazardous materials, counterfeit goods, or items restricted
          by airline or customs authorities).
        </li>
        ...
        <li>
          Complete transactions agreed upon, unless a legitimate reason prevents
          it (e.g., cancellation agreed by both parties).
        </li>
      </ul>
      <p>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 text-primary dark:text-secondary">
        4. Listings, Bookings, and Payments
      </h2>
      <ul className="list-disc list-inside ml-4 space-y-2">
        <li>
          <strong>Listings:</strong> Yankers may create listings detailing their
          travel plans and available baggage space. Senders may search for these
          listings.
        </li>
        <li>
          <strong>Agreements:</strong> Senders and Yankers negotiate and agree
          upon the terms of service (item(s), price, pickup/delivery) through
          the Platform's communication tools. This agreement forms a binding
          contract between the Sender and Yanker.
        </li>
        <li>
      ...
      <p>
        ...
        access or use the Platform; (ii) any conduct or content of any third
        party on the Platform; (iii) any content obtained from the Platform; and
      ...
      <p>
        ...
        your use and access of the Platform, by you or any person using your
      ...
      <p>
        ...
        account, you may simply discontinue using the Platform or contact us to
      ...
      <p>
        ...
        to access or use our Platform after any revisions become effective, you
      ...
      <p>
        ...
        <a
          href="mailto:legal@yankit.com.au"
