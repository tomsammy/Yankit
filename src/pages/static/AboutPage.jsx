      ...
      return (
        <StaticPageLayout title="About Yankit" icon={Users}>
          ...
          <ul className="list-disc list-inside ml-4 space-y-2">
            <li><strong>Senders:</strong> Individuals or businesses looking for a cost-effective way to send items. Senders are matched with travellers, pay securely, and drop their items at a designated Yankit point for safety assessment.</li>
            <li><strong>Yankers (Travellers):</strong> Individuals who are travelling and have spare baggage allowance (up to 2 bags, 20kg each). They list their trip, get matched, and pick up pre-assessed bags from Yankit staff to carry for a fee.</li>
          </ul>
          <p>
            Our platform provides the algorithm to match these pairs, secure payment processing, and a safe handover process involving Yankit staff assessment.
          </p>

          <h2 className="text-2xl font-semibold mt-8 mb-4 text-primary dark:text-secondary">Our Values</h2>
          <ul className="list-disc list-inside ml-4 space-y-2">
            <li><strong>Trust & Safety:</strong> We prioritize safety by requiring senders to sign dangerous goods declarations and having all bags assessed by Yankit staff before handover to the traveller.</li>
