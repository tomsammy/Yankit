    ...
    <StaticPageLayout title="About Yankit" icon={Users}>
      ...
      <ul className="list-disc list-inside ml-4 space-y-2">
        <li>
          ...
          pay securely, and drop their items at a designated Yankit point for
          safety assessment.
        </li>
        <li>
          ...
          their trip, get matched, and pick up pre-assessed bags from Yankit
          staff to carry for a fee.
        </li>
      </ul>
      <p>
        Our platform provides the algorithm to match these pairs, secure payment
        processing, and a safe handover process involving Yankit staff
        assessment.
      </p>
      ...
      <p>
        ...
        to making <span className="font-vernaccia-bold">Yankit</span> the
