...
const AboutPage = () => {
  return (
    <StaticPageLayout title="About Baggit" icon={Users}>
      <p>
        Welcome to <span className="font-vernaccia-bold">Baggit</span>! We are
      ...
      <p>
        ...
        reliable, and user-friendly platform that leverages the collective power
        of the travelling community. We believe in creating a more connected
        world where sharing resources benefits everyone.
      </p>
      ...
      <p>
        <span className="font-vernaccia-bold">Baggit</span> facilitates
        connections between:
      </p>
      <ul className="list-disc list-inside ml-4 space-y-2">
        <li>
          <strong>Senders:</strong> Individuals or businesses looking for a
          cost-effective way to send items. Senders are matched with travellers,
          pay securely, and drop their items at a designated Baggit point for
          safety assessment.
        </li>
        <li>
          <strong>Yankers (Travellers):</strong> Individuals who are travelling
          and have spare baggage allowance (up to 2 bags, 20kg each). They list
          their trip, get matched, and pick up pre-assessed bags from Baggit
          staff to carry for a fee.
        </li>
      </ul>
      <p>
        Our platform provides the algorithm to match these pairs, secure payment
        processing, and a safe handover process involving Baggit staff
        assessment.
      </p>
      ...
      <ul className="list-disc list-inside ml-4 space-y-2">
        <li>
          ...
          assessed by Baggit staff before handover to the traveller.
        </li>
        <li>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 text-primary dark:text-secondary">
        The <span className="font-vernaccia-bold">Baggit</span> Team
      </h2>
      <p>
        Based in Brisbane, Australia, our dedicated team is comprised of tech
        enthusiasts, travel lovers, and customer service professionals committed
        to making <span className="font-vernaccia-bold">Baggit</span> the
        leading platform for peer-to-peer item sharing.
      </p>
      <p>
        Thank you for being part of the{" "}
        <span className="font-vernaccia-bold">Baggit</span> community!
      </p>
    </StaticPageLayout>
  );
};
