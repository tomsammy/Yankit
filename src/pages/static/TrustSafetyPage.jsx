      ...
      return (
        <StaticPageLayout title="Trust & Safety at Yankit" icon={ShieldCheck}>
          ...
          <ul className="list-disc list-inside ml-4 space-y-3">
            <li>
              <strong>Yankit Staff Assessment:</strong> To ensure safety, all bags must be dropped off by the sender at a designated Yankit drop-off point. Our staff assesses the items before they are handed over to the traveller.
            </li>
            <li>
              <strong>Dangerous Goods Declaration:</strong> Senders are required to sign a declaration form confirming they are not sending any dangerous or prohibited goods.
            </li>
            <li>
            ...
            <li>
              <strong>Prohibited Items & Activities:</strong> <span className="font-vernaccia-bold">Yankit</span> strictly prohibits the sending or carrying of illegal goods, hazardous materials, weapons, counterfeit items, and any other items restricted by airline regulations or customs laws.
            </li>
            <li>
          ...
          <ul className="list-disc list-inside ml-4 space-y-2">
            ...
            <li><strong>Sign the Declaration:</strong> Ensure you read and sign the dangerous goods declaration truthfully.</li>
            ...
            <li><strong>Drop Off Securely:</strong> Drop your bag only at the designated Yankit drop-off point for assessment.</li>
            <li><strong>Confirm Receipt Promptly:</strong> Once your recipient receives the items, confirm delivery on the platform so the Yanker can be paid.</li>
          </ul>

          <h3 className="text-xl font-semibold mt-6 mb-2 text-slate-800 dark:text-slate-100">For Yankers (Travellers):</h3>
          <ul className="list-disc list-inside ml-4 space-y-2">
            <li><strong>Pick Up Assessed Bags:</strong> Only pick up bags from the designated Yankit drop-off point after they have been assessed by our staff.</li>
            <li><strong>Understand Regulations:</strong> Be aware of customs and airline regulations for both your origin and destination countries.</li>
            <li><strong>Communicate Your Availability:</strong> Clearly state your travel dates and baggage capacity (max 2 bags, 20kg each).</li>
