  ...
  return (
    <StaticPageLayout title="Press & Media" icon={Newspaper}>
      ...
      <p>
        ...
        leveraging technology to create a global network for smarter logistics.
      </p>
      ...
      <p>Stay updated with our latest announcements and milestones.</p>
      ...
      <p>
        For all media inquiries, interview requests, or to be added to our press
        list, please contact:
      </p>
