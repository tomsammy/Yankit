    ...
    const PrivacyPolicyPage = () => {
      ...
      return (
        <StaticPageLayout title="Privacy Policy" icon={Lock}>
          ...
          <p>
            <span className="font-vernaccia-bold">Yankit</span> Proprietary Ltd. ("<span className="font-vernaccia-bold">Yankit</span>," "we," "us," or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website, mobile applications, and services (collectively, the "Platform"). Please read this policy carefully.
          </p>
          <p>
          ...
          <p>
            ...
            Address: Privacy Officer, <span className="font-vernaccia-bold">Yankit</span> Proprietary Ltd., Building 5, 22 Magnolia Dr, Brookwater QLD 4300, Australia.
          </p>
          <p>
