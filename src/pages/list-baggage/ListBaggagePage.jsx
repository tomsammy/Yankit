...
const ListBaggagePage = () => {
  ...
  const renderForm = () => (
    <>
      <SEO
        title="Send a Parcel Internationally | Yankit"
        description="Send your packages abroad for less. Search for travelers, pay securely, track delivery. No hidden fees.
