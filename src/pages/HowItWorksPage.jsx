...
const HowItWorksPage = () => {
  const senderSteps = [
    { icon: Search, title: "Match & Notify", description: "Our algorithm matches your route with a traveller's available space and notifies you of the slot.", colorClass: "bg-primary" },
    { icon: ClipboardCheck, title: "Pay & Declare", description: "Accept the match, make payment, provide recipient details, and sign the dangerous goods declaration.", colorClass: "bg-primary" },
    { icon: MapPin, title: "Drop Off & Assess", description: "Drop your bag at the designated Yankit drop-off point near the departure airport for staff assessment.", colorClass: "bg-primary" },
    { icon: CheckCircle, title: "Track & Confirm", description: "Track your bag as the traveller picks it up and delivers it to your recipient.", colorClass: "bg-primary" },
  ];

  const travelerSteps = [
    { icon: Briefcase, title: "List Your Space", description: "List your origin and destination airports and available baggage allowance (max 2 bags, 20kg each).", colorClass: "bg-primary" },
    { icon: Users, title: "Get Matched", description: "Our system matches you with a sender and notifies you to pick up a bag.", colorClass: "bg-primary" },
    { icon: Shield, title: "Pick Up Securely", description: "Pick up the bag from the Yankit drop-off point, where it has been safely assessed by our staff.", colorClass: "bg-primary" },
    { icon: Landmark, title: "Deliver & Earn", description: "Deliver the bag to the recipient at the destination airport and receive your payment.", colorClass: "bg-primary" },
  ];

  const benefits = [
    { icon: Globe, title: "Global Reach", description: "Send and receive items across continents with a community of trusted travelers." },
    { icon: Shield, title: "Secure Assessment", description: "All bags are assessed by Yankit staff at drop-off points for safety and peace of mind." },
    ...
    <div className="min-h-screen bg-gray-100 text-gray-900 py-12 md:py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            Yankit is a revolutionary way that brings together travellers with those wanting to send anything, anywhere, domestically or internationally. It is a simple platform that enables travellers to list their allowable baggage space, and our algorithm matches them with senders for a seamless, secure experience.
          </motion.p>
        </motion.section>
        ...
        >
          ...
          <p className="text-center text-gray-700 mb-10 md:mb-12 max-w-2xl mx-auto">Follow these simple steps to send your items securely.</p>
