    ...
    >
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2
              className="text-3xl md:text-4xl font-extrabold text-foreground dark:text-white mb-2"
              dangerouslySetInnerHTML={{ __html: officeDetails.name }}
            ></h2>
            <p className="text-lg text-muted-foreground dark:text-slate-300 mb-8">
              ...
              below, or visit us at our main office.
            </p>
            ...
            {[
              {
                ...
                href: `https://www.openstreetmap.org/search?query=${encodeURIComponent(officeDetails.address)}`,
              },
              {
                icon: <MapPin className="w-6 h-6 text-primary" />,
                label: "Location",
                value: "Brookwater, QLD, Australia",
              },
              {
          ...
          >
            <p className="text-muted-foreground dark:text-slate-400 text-center p-4">
              Map visualization is currently unavailable. <br /> Please use the
