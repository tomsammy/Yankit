...
const features = [
  {
    ...
    description:
      "Quickly find travelers with available baggage space matching your destination and dates.",
  },
  {
    icon: <PackagePlus className="w-8 h-8 text-primary" />,
    title: "Simple Listing",
    description:
      "Easily list your available baggage space and connect with potential shippers.",
  },
  {
    icon: <MessageSquare className="w-8 h-8 text-primary" />,
    title: "In-App Messaging",
    description:
      "Securely communicate with other users to coordinate details and arrange handovers.",
  },
  {
    icon: <CreditCard className="w-8 h-8 text-primary" />,
    title: "Secure Payments",
    description:
      "Integrated payment system for safe and reliable transactions between shippers and travelers.",
  },
  {
    icon: <MapPin className="w-8 h-8 text-primary" />,
    title: "Shipment Tracking",
    description:
      "Stay updated on your shipment's progress with real-time tracking from pickup to delivery.",
  },
  {
    icon: <Users className="w-8 h-8 text-primary" />,
    title: "User Profiles & Reviews",
    description:
      "Build trust within the community through detailed profiles and user feedback.",
  },
];
