...
const safetyFeatures = [
  {
    ...
    description:
      "All users undergo a verification process to enhance platform security.",
  },
  {
    icon: <ShieldCheck className="w-10 h-10 text-primary" />,
    title: "Secure Payments",
    description:
      "Payments are handled securely through our platform, protecting both parties.",
  },
  {
    icon: <MessageCircle className="w-10 h-10 text-primary" />,
    title: "Transparent Communication",
    description:
      "In-app messaging allows for clear and documented communication.",
  },
  {
    icon: <Star className="w-10 h-10 text-primary" />,
    title: "Review System",
    description:
      "Rate and review users to build trust and maintain community standards.",
  },
];
