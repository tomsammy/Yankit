          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                size="lg"
                asChild
                className="w-full sm:w-auto bg-white text-primary hover:bg-slate-100 shadow-lg px-8 py-3 text-base font-semibold"
              >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                ...
                size="lg"
                asChild
                className="w-full sm:w-auto bg-transparent border-2 border-white/80 text-white hover:bg-white/10 hover:text-white shadow-lg px-8 py-3 text-base"
              >
