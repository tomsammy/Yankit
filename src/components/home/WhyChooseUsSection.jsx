...
const features = [
  {
    ...
    description:
      "Save significantly on international shipping costs by utilizing unused baggage space.",
  },
  {
    icon: <Globe className="w-10 h-10 text-primary mb-4" />,
    title: "Global Reach",
    description:
      "Connect with a vast network of travelers going to numerous destinations worldwide.",
  },
  {
    icon: <ShieldCheck className="w-10 h-10 text-primary mb-4" />,
    title: "Secure & Trusted",
    description:
      "Verified users and transparent processes ensure peace of mind for both shippers and travelers.",
  },
  {
    icon: <Users className="w-10 h-10 text-primary mb-4" />,
    title: "Community Driven",
    description:
      "Be part of a growing community that supports peer-to-peer exchange and sharing.",
  },
  {
    icon: <Zap className="w-10 h-10 text-primary mb-4" />,
    title: "Faster Deliveries",
    description:
      "Often get your items delivered faster than traditional shipping methods.",
  },
  {
    icon: <Lock className="w-10 h-10 text-primary mb-4" />,
    title: "Earn While You Travel",
    description:
      "Monetize your extra baggage allowance and offset your travel expenses.",
  },
];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-extrabold text-foreground dark:text-white mb-3">
            Why Choose <span className="font-vernaccia-bold">Baggit</span>?
          </h2>
          <p className="text-lg text-muted-foreground dark:text-slate-300 max-w-2xl mx-auto">
            Discover the unique advantages of using{" "}
            <span className="font-vernaccia-bold">Baggit</span> for your
            shipping and travel needs.
          </p>
        </motion.div>
