import React, { useState, useEffect, useCallback, useRef } from 'react';
    ...
    const UniversalSearchForm = ({ initialMode = 'send', onSearch }) => {
      ...
      const findAirportByCode = (code) => globalAirportsList.find(airport => airport.value === code) || null;
      ...
      useEffect(() => {
        if (location.state?.searchCriteria) {
          ...
          setNumberOfBags(bags || 1);
            ...
            const { origin: prefillOriginCode, destination: prefillDestinationCode } = location.state.prefillSearch;
