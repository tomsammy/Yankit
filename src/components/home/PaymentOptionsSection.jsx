import React from 'react';
    ...
    import { CreditCard, ShieldCheck, Smartphone, Wallet, Route } from 'lucide-react';
    ...
    const paymentOptions = [
      ...
      },
      {
        ...
        title: "Revolut Pay",
        description: "Experience seamless and instant payments with Revolut Pay. Fast, secure, and convenient for all your transactions.",
      },
      {
      ...
      },
      {
        ...
        description: "All prices are clearly calculated based on the specific route and bag details, ensuring fair and non-negotiable costs for every shipment.",
      },
      {
        icon: <ShieldCheck className="w-10 h-10 text-green-500 mb-4" />,
        title: "Secure Transactions",
        description: "<span class='font-vernaccia-bold'>Yankit</span> holds funds securely until successful delivery confirmation, providing complete peace of mind for both shippers and travelers.",
      },
    ];
