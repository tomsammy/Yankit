      ...
      <DialogContent className="sm:max-w-[480px] p-0 overflow-hidden glassmorphism-modal">
        <div className="p-6 md:p-8">
          ...
          {showSenderNote && (
            <Alert
              variant="default"
              className="mb-6 bg-primary/10 dark:bg-blue-600/20 border-primary/30 dark:border-blue-500/40"
            >
              <Info className="h-4 w-4 text-primary dark:text-blue-300" />
              <AlertTitle className="font-semibold text-primary dark:text-blue-200">
