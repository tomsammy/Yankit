...
export const SignInLink = () => (
  <CardFooter className="p-6 pt-4 text-center flex flex-col items-center">
    ...
    <Button
      variant="link"
      asChild
      className="font-medium text-primary hover:underline dark:text-secondary flex items-center justify-center mt-1 group p-0 h-auto"
    >
      <Link to="/signin">
        <LogIn className="w-4 h-4 mr-1 transition-transform duration-300 group-hover:translate-x-1" />{" "}
        Sign In Instead{" "}
