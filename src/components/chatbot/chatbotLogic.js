...
const conversationFlows = {
  initial: {
    ...
    options: [
      ...
      {
        id: "how_to_send",
        text: "How do I send an item?",
        icon: SendIcon,
        nextFlow: "sendingItemInfo",
      },
      {
        id: "how_to_offer",
        text: "How do I offer baggage space?",
        icon: BaggageClaim,
        nextFlow: "offeringBaggageInfo",
      },
      {
        id: "baggage_rules",
        text: "Baggage Rules & Limits",
        icon: BaggageClaim,
        nextFlow: "baggageAllowanceInfo",
      },
      {
        id: "safety_trust",
        text: "Safety & Trust",
      ...
      {
        id: "account_help_initial",
        text: "Account Help",
        icon: UserCircle,
        nextFlow: "accountHelp",
      },
      {
        id: "contact_support_initial",
        text: "Contact Support",
        icon: Phone,
        nextFlow: "contactSupport",
      },
    ],
    keywordResponses: {
    ...
    options: [
      {
        ...
        text: "Tell me about Flights",
        icon: Plane,
        nextFlow: "bookingFlightInfo",
      },
      {
        id: "learn_sending_from_about",
        text: "How to send items",
        icon: SendIcon,
        nextFlow: "sendingItemInfo",
      },
      {
        id: "learn_offering_from_about",
        text: "How to offer space",
        icon: BaggageClaim,
        nextFlow: "offeringBaggageInfo",
      },
      {
        id: "main_menu_from_about",
        text: "Main Menu",
        icon: Menu,
        nextFlow: "initial",
      },
  ...
  sendingItemInfo: {
    ...
    options: [
      ...
      {
        id: "payment_info_sending",
        text: "About Payments",
        icon: DollarSign,
        nextFlow: "feesInfo",
      },
      {
        id: "prohibited_items_q",
        text: "What can I send?",
        icon: AlertTriangle,
        nextFlow: "prohibitedItemsInfo",
      },
      {
        id: "main_menu_from_sending",
        text: "Main Menu",
        icon: Menu,
        nextFlow: "initial",
      },
  ...
  offeringBaggageInfo: {
    ...
    options: [
      ...
      {
        id: "baggage_rules_offering",
        text: "Baggage Rules",
        icon: BaggageClaim,
        nextFlow: "baggageAllowanceInfo",
      },
      {
        id: "main_menu_from_offering",
        text: "Main Menu",
        icon: Menu,
        nextFlow: "initial",
      },
    ...
    options: [
      {
        ...
        text: "What items are prohibited?",
        icon: AlertTriangle,
        nextFlow: "prohibitedItemsInfo",
      },
      {
        id: "safety_guidelines_allowance",
        text: "Safety Guidelines",
        icon: ShieldCheck,
        nextFlow: "safetyInfo",
      },
      {
        id: "main_menu_from_allowance",
        text: "Main Menu",
        icon: Menu,
        nextFlow: "initial",
      },
  ...
  prohibitedItemsInfo: {
    response:
      "You CANNOT send or carry: illegal substances, weapons, hazardous materials, counterfeit goods, perishable items requiring special handling (unless agreed), or anything restricted by airlines or customs in origin/destination countries. Always declare contents honestly. See our Trust & Safety page for more.",
    options: [
      {
        id: "trust_safety_page_prohibited",
        text: "Visit Trust & Safety",
        icon: ShieldCheck,
        action: "navigate",
        path: "/trust-safety",
        nextFlow: "initial",
      ...
      {
        id: "baggage_allowance_from_prohibited",
        text: "Baggage Limits",
        icon: BaggageClaim,
        nextFlow: "baggageAllowanceInfo",
      },
      {
        id: "main_menu_from_prohibited",
        text: "Main Menu",
        icon: Menu,
        nextFlow: "initial",
      },
  ...
  feesInfo: {
    ...
    options: [
      ...
      {
        id: "contact_support_fees",
        text: "More Questions?",
        icon: Phone,
        nextFlow: "contactSupport",
      },
      {
        id: "main_menu_from_fees",
        text: "Main Menu",
        icon: Menu,
        nextFlow: "initial",
      },
  ...
  safetyInfo: {
    ...
    options: [
      ...
      {
        id: "prohibited_items_from_safety",
        text: "Prohibited Items",
        icon: AlertTriangle,
        nextFlow: "prohibitedItemsInfo",
      },
      {
        id: "main_menu_from_safety",
        text: "Main Menu",
        icon: Menu,
        nextFlow: "initial",
      },
  ...
  accountHelp: {
    ...
    options: [
      {
        id: "password_reset_acc",
        text: "Password Reset",
        icon: Lock,
        nextFlow: "passwordResetInfo",
      },
      {
        id: "update_profile_acc",
        text: "Update Profile/Email",
        icon: Edit3,
        nextFlow: "updateProfileInfo",
      },
      {
        id: "verification_acc",
        text: "Account Verification",
        icon: ShieldCheck,
        nextFlow: "verificationInfo",
      },
      {
        id: "main_menu_from_account",
        text: "Main Menu",
        icon: Menu,
        nextFlow: "initial",
      },
  ...
  passwordResetInfo: {
    response:
      "To reset your password, please go to the Sign In page and click on the 'Forgot Password?' link. You'll receive an email with instructions.",
    options: [
      {
        id: "go_to_signin_pw",
        text: "Go to Sign In",
      ...
      {
        id: "back_to_account_help_pw",
        text: "Account Help Menu",
        icon: UserCircle,
        nextFlow: "accountHelp",
      },
      {
        id: "main_menu_from_pw",
        text: "Main Menu",
        icon: Menu,
        nextFlow: "initial",
      },
  ...
  updateProfileInfo: {
    response:
      "You can update your profile information, including your email address, from your Dashboard after signing in.",
    options: [
      {
        id: "go_to_dashboard_profile",
      ...
      {
        id: "back_to_account_help_profile",
        text: "Account Help Menu",
        icon: UserCircle,
        nextFlow: "accountHelp",
      },
      {
        id: "main_menu_from_profile",
        text: "Main Menu",
        icon: Menu,
        nextFlow: "initial",
      },
  ...
  verificationInfo: {
    response:
      "Account verification helps build trust in the community. You may be prompted to verify your identity. Follow the instructions in your account settings or when prompted. For issues, contact support.",
    options: [
      {
        id: "contact_support_verif",
        text: "Contact Support",
        icon: Phone,
        nextFlow: "contactSupport",
      },
      {
        id: "back_to_account_help_verif",
        text: "Account Help Menu",
        icon: UserCircle,
        nextFlow: "accountHelp",
      },
      {
        id: "main_menu_from_verif",
        text: "Main Menu",
        icon: Menu,
        nextFlow: "initial",
      },
  ...
  disputeInfo: {
    response:
      "If you have an issue with a transaction or another user, first try to resolve it through in-app messaging. If that fails, please gather all details (conversation screenshots, etc.) and contact our support team via the Support page. We'll do our best to mediate.",
    options: [
      {
        id: "go_to_support_dispute",
        text: "Contact Support",
        icon: Phone,
        nextFlow: "contactSupport",
      },
      {
        id: "safety_tips_dispute",
        text: "Safety Tips",
        icon: ShieldCheck,
        nextFlow: "safetyInfo",
      },
      {
        id: "main_menu_from_dispute",
        text: "Main Menu",
        icon: Menu,
        nextFlow: "initial",
      },
  ...
  contactSupport: {
    response:
      "You can reach our support team via the 'Support' page on our website. There you'll find FAQs, contact methods, and our office address. For urgent matters, please check the contact options there.",
    options: [
      {
        id: "go_to_support",
  ...
  fallback: {
    response:
      "I'm not quite sure how to help with that. Please choose one of the options below, or try phrasing your question differently. You can also visit our Support page for more detailed help.",
    options: [
      {
        id: "fallback_initial",
        text: "Main Menu",
...
export const getInitialGreeting = () => {
  return {
    id: "greeting",
    text: conversationFlows.initial.greeting,
    sender: "bot",
  };
};
...
const findKeywordMatch = (flowState, userInput) => {
  ...
  for (const keywordId in flowKeywords) {
    if (
      userInput.includes(keywordId) ||
      (commonKeywords[keywordId] &&
        commonKeywords[keywordId].some((k) => userInput.includes(k)))
    ) {
...
export const getResponse = (currentFlow, userInput) => {
  ...
  if (
    userInput === "back_to_main" ||
    userInput === "main_menu" ||
    userInput === "fallback_initial"
  ) {
    return {
      text: conversationFlows.initial.greeting,
      nextFlow: "initial",
      action,
      path,
      options: conversationFlows.initial.options,
    };
  }
  ...
  if (!flow)
    return {
      text: conversationFlows.fallback.response,
      nextFlow: "fallback",
      action,
      path,
      options: conversationFlows.fallback.options,
    };
  ...
  const nextFlowState =
    conversationFlows[nextFlowKey] || conversationFlows.fallback;
  const responseText =
    nextFlowState.response || conversationFlows.fallback.response;
  const responseOptions =
    nextFlowState.options || conversationFlows.fallback.options;

  return {
    text: responseText,
    nextFlow: nextFlowKey,
    action,
    path,
