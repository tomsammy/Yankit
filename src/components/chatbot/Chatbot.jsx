        ...
        {isOpen && (
          ...
          >
              ...
              <div className="p-3 border-t border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {currentOptions.map((option) => (
                    ...
                    >
                      {option.icon && (
                        <option.icon size={18} className="mr-2 shrink-0" />
                      )}
                      <span
                        className="whitespace-normal leading-tight text-xs sm:text-sm"
            ...
            <form
              ...
              className="p-3 border-t border-slate-200 dark:border-slate-700 flex items-center space-x-2 bg-white dark:bg-slate-800"
            >
              {currentFlow !== "initial" && (
                <Button
                  type="button"
